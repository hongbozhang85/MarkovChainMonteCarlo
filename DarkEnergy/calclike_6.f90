...
real(kind=8) :: myhubble, z, P(num_params),z2=0.9
!real(kind=8),external :: Intergal1,Intergal2,Intergal3

! param = [omegam0,h100,omegab,z1,a0,a1,a2]

if ( z < P(4) ) then

  myhubble = sqrt(P(1)*((1+z)**3) + 4.15D-5*((1+z)**4)/(P(2)*P(2)) + (1- P(1))*Intergal1(P(4),P(5),P(6),z))

else if ( z>=P(4) .and. z<=z2 ) then

  myhubble = sqrt(P(1)*((1+z)**3) + 4.15D-5*((1+z)**4)/(P(2)*P(2)) + (1- P(1))*Intergal2(P(4),P(5),P(6),P(7),z2,z))

else if ( z>z2 ) then
  
  myhubble = sqrt(P(1)*((1+z)**3) + 4.15D-5*((1+z)**4)/(P(2)*P(2)) + (1- P(1))*Intergal3(P(4),P(5),P(6),P(7),z2,z))
...
function Intergal2(z1,a0,a1,a2,z2,z)
implicit none

real(kind=8) :: Intergal2,z1,a0,a1,a2,z2,z

Intergal2 = ((1+z1)**(3*(1+a0-(a1-a0)/z1)))*(((1+z)/(1+z1))**(3*(1+a1-(a2-a1)/(z2-z1)-z1*(a2-a1)/(z2-z1))))&
&*exp(3*(a1-a0) + 3*(z-z1)*(a2-a1)/(z2-z1))
...
function Intergal3(z1,a0,a1,a2,z2,z)
implicit none

real(kind=8) :: Intergal3,z1,a0,a1,a2,z2,z

Intergal3=((1+z1)**(3*(1+a0-(a1-a0)/z1)))*(((1+z2)/(1+z1))**(3*(1+a1-(a2-a1)/(z2-z1)-z1*(a2-a1)/(z2-z1))))&
