...
real(kind=8),parameter :: z4=1.8, a=-1.0

! num_params=11, P = [omegam,h100,omegab,z1,z2,a0,a1,a2,a3,z3,a4]
! Here [z0=0,z1,z2,z3,z4=1.8] [a0,a1,a2,a3,a4,a=1.8]

if ( z < P(4) ) then

  myhubble = sqrt(P(1)*((1+z)**3) + 4.15D-5*((1+z)**4)/(P(2)*P(2)) +(1- P(1))*Intergal1(P(4),P(6),P(7),z))

else if ( z>=P(4) .and. z<=P(5) ) then

  myhubble = sqrt(P(1)*((1+z)**3) + 4.15D-5*((1+z)**4)/(P(2)*P(2)) + (1- P(1))*Intergal2(P(4),P(5),P(6),P(7),P(8),z))

else if ( z>P(5) .and. z<=P(10) ) then

  myhubble = sqrt(P(1)*((1+z)**3)+ 4.15D-5*((1+z)**4)/(P(2)*P(2)) + (1- P(1))*Intergal3(P(4),P(5),P(6),P(7),P(8),P(9),P(10),z))

else if ( z>P(10) .and. z<=z4 ) then
  
  myhubble = sqrt(P(1)*((1+z)**3)+ 4.15D-5*((1+z)**4)/(P(2)*P(2)) + (1- P(1))*Intergal4(P(4),P(5),P(6),P(7),P(8),P(9),P(10),P(11),z4,z))

else if ( z>z4 ) then
  
myhubble=sqrt(P(1)*((1+z)**3)+ 4.15D-5*((1+z)**4)/(P(2)*P(2))+(1-P(1))*Intergal5(P(4),P(5),P(6),P(7),P(8),P(9),P(10),P(11),z4,a,z))
...
function Intergal4(z1,z2,a0,a1,a2,a3,z3,a4,z4,z)
implicit none

real(kind=8) :: Intergal4,z1,z2,a0,a1,a2,a3,z3,a4,z4,z
!real,external :: Intergral3

Intergal4 = Intergal3(z1,z2,a0,a1,a2,a3,z3,z3)*(((1+z)/(1+z3))**(3*(1+a3-(1+z3)*(a4-a3)/(z4-z3))))*exp(3*(z-z3)*(a4-a3)/(z4-z3))
...
function Intergal5(z1,z2,a0,a1,a2,a3,z3,a4,z4,a,z)
implicit none

real(kind=8) :: Intergal5,z1,z2,a0,a1,a2,a3,z3,a4,z4,a,z
!real,external :: Intergral4

Intergal5 = Intergal4(z1,z2,a0,a1,a2,a3,z3,a4,z4,z4)*(((1+z)/(1+z4))**(3*(1+a)))
