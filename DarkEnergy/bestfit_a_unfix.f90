...
! 307Union + R + A / SuQP's Model 2 Bins with z2 fixed to 1
...
!!!  beginx(6) = -1.0
  ...
  beginx(1) = 0.279332821649916
  beginx(2) = 0.303861908246290
  beginx(3) = -0.887466769079083
  beginx(4) = -1.22780448356212
  beginx(5) = 0.623514455394911
  beginx(6) = -1.17530251878293
...
real(kind=8) :: Intergal3,z1,z2,a0,a1,a2,a,z
